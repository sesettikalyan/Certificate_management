                ...
                <div>
                    ...
                    >
                        <div>
                            ...
                            <div className="flex justify-center list-none mt-16">
                        ...
                        <div>
                            <div>
                                ...
                                <div className="p-[10%]">
                                    <p>All mock exam contains details explanation of each question, you will have opportunity to view details. You can open test in learning mode of Exam mode.</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. At harum dolore aperiam? Earum repellendus quisquam amet iusto perferendis corporis delectus cupiditate, error quam, aut labore esse mollitia ea ipsum reiciendis.</p>
                                </div>
                                <div className="flex justify-center list-none">
                                    <li className="text-slate-300"><GoDotFill /></li>
                                    <li className="text-slate-300"><GoDotFill /></li>
